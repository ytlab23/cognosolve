    ...
    <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto my-12" id="blog">
      ...
      >
        <h2 className="text-4xl text-neutralDGrey font-semibold mb-4">
          Insights for AI-driven Innovation
        </h2>
        <p className="text-sm text-neutralGrey mb-8 md:w-3/4 mx-auto">
          Explore our blog for the latest insights and trends in AI consulting.
          Learn how businesses are leveraging AI for growth and innovation.
        </p>
      </motion.div>
